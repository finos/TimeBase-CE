...
public class Test_FieldModifierChangeMessageBuilder {
    ...
    private StreamMetaDataChange getStreamMetaDataChange() {
        ...
        deltix.qsrv.hf.pub.md.DataField newFieldState = new com.epam.deltix.qsrv.hf.pub.md.StaticDataField( "field", "title", new com.epam.deltix.qsrv.hf.pub.md.VarcharDataType("UTF8", false, false), "default_value");
