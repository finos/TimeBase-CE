...
public class Test_RelationFieldChangeMessageBuilder {
    ...
    private StreamMetaDataChange getStreamMetaDataChange() {
        ...
        NonStaticDataField newFieldState = new com.epam.deltix.qsrv.hf.pub.md.NonStaticDataField( "field", "title", new com.epam.deltix.qsrv.hf.pub.md.VarcharDataType("UTF8", false, false), "newRelation");

        RecordClassDescriptor targetDescriptor = new com.epam.deltix.qsrv.hf.pub.md.RecordClassDescriptor( "guid2", "name", "title", false, null, newFieldState);

        NonStaticDataField oldFieldState = new com.epam.deltix.qsrv.hf.pub.md.NonStaticDataField( "field", "title", new com.epam.deltix.qsrv.hf.pub.md.VarcharDataType("UTF8", false, false), "oldRelation");

        RecordClassDescriptor sourceDescriptor = new com.epam.deltix.qsrv.hf.pub.md.RecordClassDescriptor( "guid1", "name", "title", false, null, oldFieldState);
    ...
    private SchemaChangeMessage getExpectedSchemaChangeMessage() {
        ...
        deltix.timebase.messages.schema.NonStaticDataField previousFieldState = new com.epam.deltix.timebase.messages.schema.NonStaticDataField();
        ...
        deltix.timebase.messages.schema.NonStaticDataField targetField = new com.epam.deltix.timebase.messages.schema.NonStaticDataField();
