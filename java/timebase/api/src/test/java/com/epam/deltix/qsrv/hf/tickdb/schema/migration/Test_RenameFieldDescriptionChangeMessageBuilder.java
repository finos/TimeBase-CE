...
public class Test_RenameFieldDescriptionChangeMessageBuilder {
    ...
    private StreamMetaDataChange getStreamMetaDataChange() {
        ...
        deltix.qsrv.hf.pub.md.DataField newFieldState = new com.epam.deltix.qsrv.hf.pub.md.NonStaticDataField( "field", "title", new com.epam.deltix.qsrv.hf.pub.md.VarcharDataType("UTF8", false, false));
