...
public class Test_RenameFieldDescriptionChangeMessageBuilder {

    private SchemaChangeMessageBuilder schemaChangeMessageBuilder = new SchemaChangeMessageBuilder();

    @Test
    public void testRenameFieldDescriptionMigration() {
    ...
    private StreamMetaDataChange getStreamMetaDataChange() {
        ...
        com.epam.deltix.qsrv.hf.pub.md.DataField newFieldState = new com.epam.deltix.qsrv.hf.pub.md.NonStaticDataField( "field", "title", new com.epam.deltix.qsrv.hf.pub.md.VarcharDataType("UTF8", false, false));
        newFieldState.setDescription("NewDescription");
        ...
        oldFieldState.setDescription("OldDescription");
        ...
        AbstractFieldChange fieldChange = new FieldChange(oldFieldState, newFieldState, FieldAttribute.Description);
    ...
    private SchemaChangeMessage getExpectedSchemaChangeMessage() {
        ...
        previousFieldState.setDescription("OldDescription");
        ...
        renamedField.setDescription("NewDescription");
        ...
        fieldAction.setChangeTypes(SchemaFieldChangeType.DESCRIPTION_CHANGE);
