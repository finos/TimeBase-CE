...
public class Test_SetDefaultValueChangeMessageBuilder {
    ...
    private StreamMetaDataChange getStreamMetaDataChange() {
        ...
        deltix.qsrv.hf.pub.md.DataField newFieldState = new com.epam.deltix.qsrv.hf.pub.md.NonStaticDataField( "field", "title", new com.epam.deltix.qsrv.hf.pub.md.IntegerDataType("INT64", false));
        ...
        deltix.qsrv.hf.pub.md.DataField oldFieldState = new com.epam.deltix.qsrv.hf.pub.md.NonStaticDataField( "field", "title", new com.epam.deltix.qsrv.hf.pub.md.IntegerDataType("INT32", true));
