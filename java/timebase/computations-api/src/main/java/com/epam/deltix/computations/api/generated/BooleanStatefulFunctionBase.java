...
public abstract class BooleanStatefulFunctionBase implements BooleanStatefulFunction {

    protected @Bool byte value = TimebaseTypes.BOOLEAN_NULL;

    @Result
    @Override
    public @Bool byte get() {
        return value;
    }
    ...
    @Override
    public void reset() {
        value = TimebaseTypes.BOOLEAN_NULL;
    }
}