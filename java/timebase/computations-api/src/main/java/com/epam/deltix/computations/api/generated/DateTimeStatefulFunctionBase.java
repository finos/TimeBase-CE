...
public abstract class DateTimeStatefulFunctionBase implements DateTimeStatefulFunction {

    protected @TimestampMs long value = TimebaseTypes.DATETIME_NULL;

    @Result
    @Override
    public @TimestampMs long get() {
        return value;
    }
    ...
    @Override
    public void reset() {
        value = TimebaseTypes.DATETIME_NULL;
    }
}