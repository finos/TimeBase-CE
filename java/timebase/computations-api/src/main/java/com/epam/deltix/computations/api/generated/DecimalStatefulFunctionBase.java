...
public abstract class DecimalStatefulFunctionBase implements DecimalStatefulFunction {

    protected @Decimal long value = TimebaseTypes.DECIMAL64_NULL;
    ...
    @Override
    public void reset() {
        value = TimebaseTypes.DECIMAL64_NULL;
    }
}
