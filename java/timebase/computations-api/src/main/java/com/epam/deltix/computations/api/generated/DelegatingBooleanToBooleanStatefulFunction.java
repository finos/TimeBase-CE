...
public abstract class DelegatingBooleanToBooleanStatefulFunction implements BooleanToBooleanStatefulFunction {

    protected BooleanToBooleanStatefulFunction delegate;

    @Result
    @Override
    public final @Bool byte get() {
        return delegate.get();
    }

    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, @Bool byte v) {
