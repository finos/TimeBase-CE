...
public abstract class DelegatingByteToDecimalStatefulFunction implements ByteToDecimalStatefulFunction {

    protected ByteToDecimalStatefulFunction delegate;
    ...
    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, byte v) {
