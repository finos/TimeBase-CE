...
public abstract class DelegatingCharToCharStatefulFunction implements CharToCharStatefulFunction {

    protected CharToCharStatefulFunction delegate;
    ...
    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, char v) {
