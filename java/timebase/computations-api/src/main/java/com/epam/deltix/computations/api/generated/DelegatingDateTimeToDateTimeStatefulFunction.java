...
public abstract class DelegatingDateTimeToDateTimeStatefulFunction implements DateTimeToDateTimeStatefulFunction {

    protected DateTimeToDateTimeStatefulFunction delegate;

    @Result
    @Override
    public final @TimestampMs long get() {
        return delegate.get();
    }

    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, @TimestampMs long v) {
