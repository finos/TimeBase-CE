...
public abstract class DelegatingDecimalToDecimalStatefulFunction implements DecimalToDecimalStatefulFunction {

    protected DecimalToDecimalStatefulFunction delegate;

    @Result
    @Override
    public final @Decimal long get() {
        return delegate.get();
    }

    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, @Decimal long v) {
