...
public abstract class DelegatingDoubleToDoubleStatefulFunction implements DoubleToDoubleStatefulFunction {

    protected DoubleToDoubleStatefulFunction delegate;
    ...
    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, double v) {
