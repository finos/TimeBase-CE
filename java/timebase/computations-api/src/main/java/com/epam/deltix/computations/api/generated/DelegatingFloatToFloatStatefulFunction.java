...
public abstract class DelegatingFloatToFloatStatefulFunction implements FloatToFloatStatefulFunction {

    protected FloatToFloatStatefulFunction delegate;
    ...
    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, float v) {
