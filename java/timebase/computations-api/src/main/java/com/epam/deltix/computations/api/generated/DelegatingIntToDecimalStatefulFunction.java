...
public abstract class DelegatingIntToDecimalStatefulFunction implements IntToDecimalStatefulFunction {

    protected IntToDecimalStatefulFunction delegate;
    ...
    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, int v) {
