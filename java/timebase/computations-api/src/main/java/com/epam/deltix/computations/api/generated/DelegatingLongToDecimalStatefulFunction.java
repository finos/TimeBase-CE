...
public abstract class DelegatingLongToDecimalStatefulFunction implements LongToDecimalStatefulFunction {

    protected LongToDecimalStatefulFunction delegate;
    ...
    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, long v) {
