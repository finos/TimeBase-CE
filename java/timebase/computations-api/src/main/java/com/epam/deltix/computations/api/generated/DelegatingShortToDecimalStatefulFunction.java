...
public abstract class DelegatingShortToDecimalStatefulFunction implements ShortToDecimalStatefulFunction {

    protected ShortToDecimalStatefulFunction delegate;
    ...
    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, short v) {
