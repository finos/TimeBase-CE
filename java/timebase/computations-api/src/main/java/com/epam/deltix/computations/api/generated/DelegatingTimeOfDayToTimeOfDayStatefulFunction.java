...
public abstract class DelegatingTimeOfDayToTimeOfDayStatefulFunction implements TimeOfDayToTimeOfDayStatefulFunction {

    protected TimeOfDayToTimeOfDayStatefulFunction delegate;

    @Result
    @Override
    public final @TimeOfDay int get() {
        return delegate.get();
    }

    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, @TimeOfDay int v) {
