...
public abstract class DelegatingVarcharToVarcharStatefulFunction implements VarcharToVarcharStatefulFunction {

    protected VarcharToVarcharStatefulFunction delegate;
    ...
    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, CharSequence v) {
