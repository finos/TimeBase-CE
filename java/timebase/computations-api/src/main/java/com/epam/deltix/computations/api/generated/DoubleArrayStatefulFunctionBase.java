...
public abstract class DoubleArrayStatefulFunctionBase implements DoubleArrayStatefulFunction {

    protected DoubleArrayList value = null;
    protected final DoubleArrayList buffer = new DoubleArrayList();
