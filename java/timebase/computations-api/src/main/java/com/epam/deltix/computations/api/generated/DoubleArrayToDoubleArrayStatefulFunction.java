...
public interface DoubleArrayToDoubleArrayStatefulFunction extends DoubleArrayStatefulFunction {

    @Compute
    void compute(@BuiltInTimestampMs long timestamp, DoubleArrayList v);
