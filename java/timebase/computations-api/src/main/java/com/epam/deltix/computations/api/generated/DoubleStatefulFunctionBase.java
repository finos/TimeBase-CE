...
public abstract class DoubleStatefulFunctionBase implements DoubleStatefulFunction {

    protected double value = TimebaseTypes.FLOAT64_NULL;
    ...
    @Override
    public void reset() {
        value = TimebaseTypes.FLOAT64_NULL;
    }
}
