...
public abstract class FloatStatefulFunctionBase implements FloatStatefulFunction {

    protected float value = TimebaseTypes.FLOAT32_NULL;
    ...
    @Override
    public void reset() {
        value = TimebaseTypes.FLOAT32_NULL;
    }
}