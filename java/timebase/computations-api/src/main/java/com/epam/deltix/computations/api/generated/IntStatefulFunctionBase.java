...
public abstract class IntStatefulFunctionBase implements IntStatefulFunction {

    protected int value = TimebaseTypes.INT32_NULL;
    ...
    @Override
    public void reset() {
        value = TimebaseTypes.INT32_NULL;
    }
}