...
public abstract class LongStatefulFunctionBase implements LongStatefulFunction {

    protected long value = TimebaseTypes.INT64_NULL;
    ...
    @Override
    public void reset() {
        value = TimebaseTypes.INT64_NULL;
    }
}