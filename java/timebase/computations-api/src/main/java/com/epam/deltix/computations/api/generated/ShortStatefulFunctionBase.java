...
public abstract class ShortStatefulFunctionBase implements ShortStatefulFunction {

    protected short value = TimebaseTypes.INT16_NULL;
    ...
    @Override
    public void reset() {
        value = TimebaseTypes.INT16_NULL;
    }
}
