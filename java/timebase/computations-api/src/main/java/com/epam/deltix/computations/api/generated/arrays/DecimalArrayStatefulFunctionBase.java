...
public abstract class DecimalArrayStatefulFunctionBase implements DecimalArrayStatefulFunction {

    protected @Decimal LongArrayList value = null;
    protected final @Decimal LongArrayList buffer = new LongArrayList();

    @Result
    @Override
    public @Decimal LongArrayList get() {
        return value;
    }
