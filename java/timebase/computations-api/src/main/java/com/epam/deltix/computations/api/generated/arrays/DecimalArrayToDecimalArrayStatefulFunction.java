...
public interface DecimalArrayToDecimalArrayStatefulFunction extends DecimalArrayStatefulFunction {

    @Compute
    void compute(@BuiltInTimestampMs long timestamp, @Decimal LongArrayList v);
