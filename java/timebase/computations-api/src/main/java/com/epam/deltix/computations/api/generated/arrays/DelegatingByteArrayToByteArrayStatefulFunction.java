...
public abstract class DelegatingByteArrayToByteArrayStatefulFunction implements ByteArrayToByteArrayStatefulFunction {

    protected ByteArrayToByteArrayStatefulFunction delegate;

    @Result
    @Override
    public final ByteArrayList get() {
        return delegate.get();
    }

    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, ByteArrayList v) {
