...
public abstract class DelegatingDecimalArrayToDecimalArrayStatefulFunction implements DecimalArrayToDecimalArrayStatefulFunction {

    protected DecimalArrayToDecimalArrayStatefulFunction delegate;

    @Result
    @Override
    public final @Decimal LongArrayList get() {
        return delegate.get();
    }

    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, @Decimal LongArrayList v) {
