...
public abstract class DelegatingDoubleArrayToDoubleArrayStatefulFunction implements DoubleArrayToDoubleArrayStatefulFunction {

    protected DoubleArrayToDoubleArrayStatefulFunction delegate;

    @Result
    @Override
    public final DoubleArrayList get() {
        return delegate.get();
    }

    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, DoubleArrayList v) {
