...
public abstract class DelegatingFloatArrayToFloatArrayStatefulFunction implements FloatArrayToFloatArrayStatefulFunction {

    protected FloatArrayToFloatArrayStatefulFunction delegate;

    @Result
    @Override
    public final FloatArrayList get() {
        return delegate.get();
    }

    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, FloatArrayList v) {
