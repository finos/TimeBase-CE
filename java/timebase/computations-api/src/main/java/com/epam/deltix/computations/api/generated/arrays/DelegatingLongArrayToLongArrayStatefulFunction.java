...
public abstract class DelegatingLongArrayToLongArrayStatefulFunction implements LongArrayToLongArrayStatefulFunction {

    protected LongArrayToLongArrayStatefulFunction delegate;

    @Result
    @Override
    public final LongArrayList get() {
        return delegate.get();
    }

    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, LongArrayList v) {
