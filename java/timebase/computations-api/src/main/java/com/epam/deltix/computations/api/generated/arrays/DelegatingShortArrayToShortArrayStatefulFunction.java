...
public abstract class DelegatingShortArrayToShortArrayStatefulFunction implements ShortArrayToShortArrayStatefulFunction {

    protected ShortArrayToShortArrayStatefulFunction delegate;

    @Result
    @Override
    public final ShortArrayList get() {
        return delegate.get();
    }

    @Compute
    @Override
    public final void compute(@BuiltInTimestampMs long timestamp, ShortArrayList v) {
