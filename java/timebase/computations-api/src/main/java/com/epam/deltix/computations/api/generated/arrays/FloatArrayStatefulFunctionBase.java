...
public abstract class FloatArrayStatefulFunctionBase implements FloatArrayStatefulFunction {

    protected FloatArrayList value = null;
    protected final FloatArrayList buffer = new FloatArrayList();

    @Result
    @Override
    public FloatArrayList get() {
        return value;
    }
