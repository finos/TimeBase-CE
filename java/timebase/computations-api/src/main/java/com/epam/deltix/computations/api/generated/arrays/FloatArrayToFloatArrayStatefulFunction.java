...
public interface FloatArrayToFloatArrayStatefulFunction extends FloatArrayStatefulFunction {

    @Compute
    void compute(@BuiltInTimestampMs long timestamp, FloatArrayList v);
