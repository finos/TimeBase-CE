...
public abstract class IntArrayStatefulFunctionBase implements IntArrayStatefulFunction {

    protected IntegerArrayList value = null;
    protected final IntegerArrayList buffer = new IntegerArrayList();
