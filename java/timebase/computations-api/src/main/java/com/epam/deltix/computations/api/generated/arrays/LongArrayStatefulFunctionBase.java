...
public abstract class LongArrayStatefulFunctionBase implements LongArrayStatefulFunction {

    protected LongArrayList value = null;
    protected final LongArrayList buffer = new LongArrayList();

    @Result
    @Override
    public LongArrayList get() {
        return value;
    }
