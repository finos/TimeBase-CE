...
public abstract class ShortArrayStatefulFunctionBase implements ShortArrayStatefulFunction {

    protected ShortArrayList value = null;
    protected final ShortArrayList buffer = new ShortArrayList();

    @Result
    @Override
    public ShortArrayList get() {
        return value;
    }
