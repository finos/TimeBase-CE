...
public interface ShortArrayToShortArrayStatefulFunction extends ShortArrayStatefulFunction {

    @Compute
    void compute(@BuiltInTimestampMs long timestamp, ShortArrayList v);
