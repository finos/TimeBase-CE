...
import com.epam.deltix.computations.api.StatefulFunction;
...
public interface VarcharArrayStatefulFunction extends StatefulFunction {

    @Result
    @Type("ARRAY(VARCHAR?)?")
    ObjectArrayList<CharSequence> get();
