...
public final class Max {
    ...
    @Function("MAX")
    @Bool
    public static byte maxBoolean(@Bool byte v1, @Bool byte v2) {
    ...
    @Function("MAX")
    public static char max(char v1, char v2) {
    ...
    @Function("MAX")
    @TimeOfDay
    public static int maxTimeOfDay(@TimeOfDay int v1, @TimeOfDay int v2) {
    ...
    @Function("MAX")
    @TimestampMs
    public static long maxTimestamp(@TimestampMs long v1, @TimestampMs long v2) {
    ...
    @Function("MAX")
    @Bool
    public static byte maxBoolean(@Nullable @Bool ByteArrayList list) {
    ...
    @Function("MAX")
    public static char max(@Nullable CharacterArrayList list) {
        if (FunctionsUtils.isNullOrEmpty(list))
    ...
    @Function("MAX")
    public static byte max(@Nullable ByteArrayList list) {
        if (FunctionsUtils.isNullOrEmpty(list))
    ...
    @Function("MAX")
    public static short max(@Nullable ShortArrayList list) {
        if (FunctionsUtils.isNullOrEmpty(list))
    ...
    @Function("MAX")
    public static int max(@Nullable IntegerArrayList list) {
        if (FunctionsUtils.isNullOrEmpty(list))
    ...
    @Function("MAX")
    public static long max(@Nullable LongArrayList list) {
        if (FunctionsUtils.isNullOrEmpty(list))
    ...
    @Function("MAX")
    public static float max(@Nullable FloatArrayList list) {
        if (FunctionsUtils.isNullOrEmpty(list))
    ...
    @Function("MAX")
    public static double max(@Nullable DoubleArrayList list) {
        if (FunctionsUtils.isNullOrEmpty(list))
    ...
    @Function("MAX")
    @Decimal
    public static long maxDecimalArray(@Nullable @Decimal LongArrayList list) {
        if (FunctionsUtils.isNullOrEmpty(list))
    ...
    @Function("MAX")
    @TimestampMs
    public static long maxTimestampArray(@Nullable @TimestampMs LongArrayList list) {
        if (FunctionsUtils.isNullOrEmpty(list))
    ...
    @Function("MAX")
    @TimeOfDay
    public static int maxTimeOfDayArray(@Nullable @TimeOfDay IntegerArrayList list) {
        if (FunctionsUtils.isNullOrEmpty(list))
    ...
    @Function("MAX")
    public static boolean max(@Nullable CharSequence cs1, @Nullable CharSequence cs2, @Nonnull @Result StringBuilder sb) {
        sb.setLength(0);
