...
import com.epam.deltix.computations.api.generated.ByteToDecimalStatefulFunctionBase;
...
@Function("AVG")
public class AvgByte extends ByteToDecimalStatefulFunctionBase {

    private long count = 0;

    @Compute
    @Override
    public void compute(@BuiltInTimestampMs long timestamp, byte v) {
