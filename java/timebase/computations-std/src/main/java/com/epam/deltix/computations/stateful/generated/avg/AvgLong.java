...
@Function("AVG")
public class AvgLong extends LongToDecimalStatefulFunctionBase {
    ...
    public void compute(@BuiltInTimestampMs long timestamp, long v) {
        ...
        value = add(value, divide(subtract(Decimal64Utils.fromLong(v), value), Decimal64Utils.fromLong(++count)));
    }
