 ...
 * the License.
 */
package com.epam.deltix.computations.stateful.generated.avg;
...
import com.epam.deltix.computations.api.generated.ShortToDecimalStatefulFunctionBase;
...
@Function("AVG")
public class AvgShort extends ShortToDecimalStatefulFunctionBase {

    private long count = 0;

    @Compute
    @Override
    public void compute(@BuiltInTimestampMs long timestamp, short v) {
        ...
        value = add(value, divide(subtract(Decimal64Utils.fromInt(v), value), Decimal64Utils.fromLong(++count)));
    }
