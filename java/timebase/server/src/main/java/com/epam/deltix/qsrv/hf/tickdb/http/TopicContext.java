...
public class TopicContext {
    ...
    public TopicContext(DXServerAeronContext aeronContext, DirectTopicRegistry topicRegistry) {
        this.aeronContext = aeronContext;
        this.topicRegistry = topicRegistry;
    }

    public DXServerAeronContext aeronContext() {
        return aeronContext;
    }

    public DirectTopicRegistry topicRegistry() {
