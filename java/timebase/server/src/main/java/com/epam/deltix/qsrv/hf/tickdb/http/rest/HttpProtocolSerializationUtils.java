 ...
 *
 */
public class HttpProtocolSerializationUtils {
    ...
    public static void writeInstrumentTypeStub(DataOutput out) throws IOException {
        out.writeByte(0);
    }

    public static void readInstrumentTypeStub(DataInput in) throws IOException {
        in.readByte();
    }

    public static void writeInstrumentTypesStub(DataOutputStream out) throws IOException {
        out.writeInt(-1);
    }

    public static void readInstrumentTypesStub(DataInputStream in) throws IOException {
        int num = in.readInt();
        if (num > 0) {
            for (int ii = 0; ii < num; ii++) {
                readInstrumentTypeStub(in);
            }
        }
    }

    public static void writeInstrumentIdentity(
        IdentityKey id,
        DataOutput out
    )
        throws IOException
    {
        writeInstrumentTypeStub(out);
        ...
        throws IOException
    {
        if (ids == null)
            ...
            for (int ii = 0; ii < length; ii++)
                writeInstrumentIdentity(ids [offset + ii], out);
        }
    }
            ...
            throws IOException
    {
        if (ids == null)
            ...
            for (IdentityKey id : ids)
                writeInstrumentIdentity(id, out);
            ...
            throws IOException
    {
        if (symbols == null) {
            ...
            for (int i = offset; i < length; i++) {
                ...
                writeInstrumentIdentity(ids[i], out);
            }
            ...
            throws IOException
    {
        if (symbols == null) {
            ...
            for (CharSequence symbol : symbols) {
                ...
                writeInstrumentIdentity(key, out);
            }
            return ids;
        }
    }
