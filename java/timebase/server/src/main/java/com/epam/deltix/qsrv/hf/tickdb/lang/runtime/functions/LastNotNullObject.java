...
import com.epam.deltix.computations.api.generated.ObjectStatefulFunction;
import com.epam.deltix.qsrv.hf.tickdb.lang.runtime.selectors.Instance;

@Function("LASTNOTNULL")
@GenericParameter(name = "T")
public class LastNotNullObject implements ObjectStatefulFunction<Instance> {

    private final Instance value;

    public LastNotNullObject() {
        value = new Instance();
    }
